  ...
  projects: [
    {
      name: "Sub0ptimal",
      description:
        "Independent video game made in Unity. Worked with five developers for part of development process with a 3 year developmenmt time. I was project lead. 22,000+ copies distributed as of 8/22/26",
